...
describe("getErrorDetails", () => {
  test("No elements found error", () => {
    ...
    expect(title).toBe("No elements found for selector");
    ...
    expect(
      screen.getByText("No elements found for selector"),
    ).toBeInTheDocument();
    expect(
  ...
  test("Multiple elements found error", () => {
    const error: ErrorObject = {
      name: "MultipleElementsFoundError",
      selector: "a",
      message: "Multiple elements found for selector",
      stack: "MultipleElementsFoundError: Multiple elements found for selector",
    };

    const { title, detailsElement } = getErrorDetails(error);
    expect(title).toBe("Multiple elements found for selector");
    ...
    expect(
      screen.getByText("Multiple elements found for selector"),
    ).toBeInTheDocument();
    expect(
      screen.getByRole("heading", { level: 5, name: "Selector" }),
    ).toBeInTheDocument();

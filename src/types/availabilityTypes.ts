...
/**
 * An availability rule. For a rule to match, there must be a match from each of the provided entries.
 *
...
/**
 * Availability with consistent shape (e.g., all fields are arrays and provided.)
 * @see Availability
 */

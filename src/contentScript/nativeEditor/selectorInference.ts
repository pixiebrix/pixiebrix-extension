...
/**
 * Generates a regex to test attribute selectors generated by `css-selector-generator`, to be used in the whitelist/blacklist arrays
 * @example getAttributeSelectorRegex('name', 'aria-label') => /^\[name(=|]$)|^\[aria-label(=|]$)/
 */

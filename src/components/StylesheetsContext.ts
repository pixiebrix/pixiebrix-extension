...
export function useStylesheetsContextWithDocumentDefault({
  ...
  return useStylesheetsContextWithDefaultValues({
    ...
    defaultStylesheets: [
      ...
      "/DocumentView.css",
      // CustomFormComponent.css works similarly, but is generated by the dynamic import in the customForm renderer.
...
export function useStylesheetsContextWithFormDefault({
  ...
  return useStylesheetsContextWithDefaultValues({
    ...
    defaultStylesheets: [
      bootstrap,
      bootstrapOverrides,
      // EphemeralFormContent.css is an artifact produced by webpack, see the EphemeralFormContent entrypoint.

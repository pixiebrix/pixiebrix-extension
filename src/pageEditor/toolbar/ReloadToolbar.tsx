...
function isPanelElement(element: ComponentFormState | null): boolean {
 ...
 */
function isAutomaticTrigger(element: ComponentFormState): boolean {
 ...
 */
export function shouldAutoRun(element: ComponentFormState): boolean {
